...
public class CodeWorker {
    ...
    public CodeWorker(Context pluginContext, Context phoneContext, Intent smsIntent) {
        this(pluginContext, phoneContext, smsIntent, com.tianma.xsmscode.common.utils.PrefBridge.loadPreferences(phoneContext != null ? phoneContext : pluginContext));
    }

    public CodeWorker(Context pluginContext, Context phoneContext, Intent smsIntent, SharedPreferences sp) {
        mPluginContext = pluginContext;
        mPhoneContext = phoneContext;
        xsp = (sp != null) ? sp : com.tianma.xsmscode.common.utils.PrefBridge.loadPreferences(phoneContext != null ? phoneContext : pluginContext);
