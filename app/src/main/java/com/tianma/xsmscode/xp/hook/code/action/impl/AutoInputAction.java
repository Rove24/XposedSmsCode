...
public class AutoInputAction extends CallableAction {
    ...
    private void autoInputCode(String code) {
        try {
            Context ctx = (mPhoneContext != null) ? mPhoneContext : mPluginContext;
            InputHelper.sendText(ctx, code);
    ...
    private boolean autoInputBlockedHere() {
        ...
        try {
            ...
            try {
                Context ctx = (mPluginContext != null) ? mPluginContext : mPhoneContext;
                ...
                Cursor cursor = resolver.query(DBProvider.APP_INFO_URI, projection, selection, selectionArgs, null);
                if (cursor != null) {
