...
public class RuleListFragment extends DaggerFragment implements RuleListContract.View {
    ...
    private void attemptExportRuleList() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            final android.widget.EditText editText = new android.widget.EditText(mActivity);
            editText.setText(defaultFilename);
            editText.setHint(hint);
            int pad = (int) (16 * getResources().getDisplayMetrics().density);
            editText.setPadding(pad, pad, pad, pad);

            final androidx.appcompat.app.AlertDialog exportFilenameDialog = new com.google.android.material.dialog.MaterialAlertDialogBuilder(mActivity, R.style.ThemeOverlay_App_MaterialAlertDialog)
                    ...
                    .setPositiveButton(R.string.confirm, (dialog, which) -> {
                        ...
                        File file = new File(BackupManager.getBackupDir(), input != null ? input.toString() : defaultFilename);
    ...
    public void showImportDialogConfirm(final Uri uri) {
        new com.google.android.material.dialog.MaterialAlertDialogBuilder(mActivity, R.style.ThemeOverlay_App_MaterialAlertDialog)
                ...
                .setPositiveButton(R.string.yes, (dialog, which) -> mPresenter.importRules(uri, true, getString(R.string.importing)))
                .setNegativeButton(R.string.no, (dialog, which) -> mPresenter.importRules(uri, false, getString(R.string.importing)))
    ...
    public void showProgress(String progressMsg) {
        if (mProgressDialog == null) {
            android.widget.ProgressBar progressBar = new android.widget.ProgressBar(mActivity);
            int pad = (int) (24 * getResources().getDisplayMetrics().density);
            progressBar.setPadding(pad, pad, pad, pad);
            mProgressDialog = new com.google.android.material.dialog.MaterialAlertDialogBuilder(mActivity, R.style.ThemeOverlay_App_MaterialAlertDialog)
